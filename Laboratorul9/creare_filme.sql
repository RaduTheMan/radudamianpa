...
CREATE TABLE charts(
  id_chart NUMBER(4) NOT NULL PRIMARY KEY,
  name VARCHAR2(30),
  creation_date DATE
)
/
...
INSERT INTO charts VALUES (1, 'Best movies', TO_DATE('02/07/2013', 'dd/mm/yyyy'));
INSERT INTO charts VALUES (2, 'Boring movies', TO_DATE('03/05/2017', 'dd/mm/yyyy'));
